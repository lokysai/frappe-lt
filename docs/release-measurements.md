...
Status (2026-09-23): **artifact bytes measured; latency not measured**. No recorded 20-run baseline/enabled timing dataset or pinned full-release Bench measurement is available here. Do not interpret a repository file size, the smoke MO digest, or a unit-test duration as release performance evidence.
